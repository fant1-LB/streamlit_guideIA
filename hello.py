...
def apropos():
    st.html('''
        ...
        Ils étaient tous trois dans des institutions patrimoniales ou de recherches différentes (l'INHA, la MSH Mondes et le musée des Arts décoratifs) et se sont retrouvés confrontés aux mêmes problèmes
        ...
        à considérer lorsqu'on veut utiliser l'IA pour l'analyse d'œuvres culturelles, afin de permettre aux institutions détentrices de collections de mieux s'y retrouver dans la galaxie de projets et de possibilités
